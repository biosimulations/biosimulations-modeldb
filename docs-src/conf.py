...
source_dir = os.path.join(os.path.dirname(__file__), '..', 'biosimulations_modeldb')
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

# -- Project information -----------------------------------------------------
source_base_url = 'https://github.com/biosimulations/biosimulations-modeldb/blob/dev/'
project = 'BioSimulations-ModelDB'
...
html_logo = "_static/biosimulations-logo.svg"

html_css_files = [
    'css/biosimulations.css',
]
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "Email",
            "url": "mailto:info@biosimulations.org",
...
html_context = {
    ...
    "github_repo": "biosimulations-modeldb",
    "github_version": "dev",
    "doc_path": "docs-src",
}
