...
def get_config(
        ...
        source_model_file_endpoint='https://github.com/ModelDBRepository/',
        source_dirname=None,
    ...
    Args:
        ...
        source_model_file_endpoint (obj:`str`, optional): endpoint for retrieving files for ModelDB models
